...
<p align="center">
<a href="https://github.com/chafan-dev/lute/blob/master/README.md">中文</a>
</p>

## 💡 Introduction

[Lute](https://github.com/chafan-dev/lute) is a structured Markdown engine that fully implements the latest [GFM](https://github.github.com/gfm/) / [CommonMark](https://commonmark.org) standard, better support for Chinese context.
...
1. Backend: Introduce `github.com/chafan-dev/lute` package in Go language
2. Backend: Start Lute as an HTTP service process for other processes to call, please refer to [here](https://github.com/chafan-dev/lute-http)
...
* [Issues](https://github.com/chafan-dev/lute/issues/new/choose)
